...
namespace UGS
{
    [CreateAssetMenu(fileName = "UGSettingObject", menuName = "Sandy/UG/SettingObject", order = 0)]
...
#endif
        [HideInInspector] public string GenerateCodePath = "Assets/UGS.Generated/Scripts/";
        [HideInInspector] public string DataPath = "Assets/UGS.Generated/Resources/";
        [HideInInspector] public string RuntimeDataPath = "UGS/UGS.Data/";

        [Header("S3 버킷 URL"), HideInInspector] public string CDN_URL = "";
        [Header("Base64 사용"), HideInInspector] public bool base64 = false;
